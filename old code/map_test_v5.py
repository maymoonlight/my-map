...
# 팝업창 구성 (전화번호 하이퍼링크 추가)
        popup_html = f"""
        <div style="width:200px; font-family: 'Malgun Gothic', sans-serif; line-height: 1.6;">
            <h4 style="margin:0 0 5px 0; color: #333;">{row['사업장명_공사장명']}</h4>
            <hr style="margin:5px 0; border: 0; border-top: 1px solid #eee;">
            <b>업종:</b> {label}<br>
            <b>연락처:</b> <a href="tel:{phone}" style="color: #007bff; text-decoration: none; font-weight: bold;">{phone}</a><br>
            <small style="color: #666;"><b>주소:</b> {row['현장주소']}</small>
        </div>
        """
