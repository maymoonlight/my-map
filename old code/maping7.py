...
for _, row in valid_df.iterrows():
    ...
    <div style="width:280px; font-family: 'Malgun Gothic', sans-serif; line-height: 1.8; padding: 5px;">
        ...
        <div style="font-size: 16px;">
            ...
            <b style="color: #333; font-size: 17px;">담당자명:</b> {site_manager}<br>
        ...
        <div style="font-size: 14px; color: #555; line-height: 1.6;">
            ...
            <b style="color: #333;">안전상태:</b> <span style="color: {disaster_color}; font-weight: bold;">{disaster_display}</span>
        </div>
    </div>
    """
...
<div id="legend-container" style="position: fixed; bottom: 20px; right: 20px; z-index: 9999;">
    <div id="legend-content" style="display: none; background-color: white; border: 2px solid #ccc; border-radius: 8px; padding: 15px; margin-bottom: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); min-width: 180px; font-size: 14px;">
        <b style="font-size: 16px; display: block; margin-bottom: 10px; border-bottom: 1px solid #eee;">📊 업종별 구분</b>
        {legend_items_html}
